...
class FileTransferQueue(WebModule, HTMLMixin):
    """
    ...
    def __init__(self, config):
        ...
        HTMLMixin.__init__(self, 'Current file transfers', 'transfers/queue.html')

        self.stylesheets = ['/css/transfers/monitor.css']
        self.scripts = ['/js/utils.js', '/js/transfers/queue.js', '/js/plotly-jan2018.min.js']
